package poja.sary.std22006.unit;
...
import poja.sary.std22006.endpoint.event.EventConsumer;
...
public class SqsMessageAckTyperTest extends FacadeIT {
  ...
  void to_acknowledgeable_typed_event_ok() throws JsonProcessingException {
    ...
    var typedEvent =
        new EventConsumer.TypedEvent("poja.sary.std22006.endpoint.event.gen.UuidCreated", payload);
